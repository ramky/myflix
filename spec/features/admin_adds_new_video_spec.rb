...
feature 'Admin adds new video' do
  scenario "Admin successfully adds a new video" do
    ...
    attach_file 'Large cover image', Rails.root.join('spec/support/uploads', 'monk_large.jpg')
    attach_file 'Small cover image', Rails.root.join('spec/support/uploads', 'monk.jpg')
